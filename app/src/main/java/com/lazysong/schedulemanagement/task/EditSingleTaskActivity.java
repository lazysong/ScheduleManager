...
public class EditSingleTaskActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_edit_single_task);
...
//		text1.setText("任务"+taskNo);
		...
		name=(EditText)findViewById(R.id.name_edit_single_task);
		des=(EditText)findViewById(R.id.description_edit_single_task);
		spinnerDiff = (Spinner)findViewById(R.id.spinner1_edit_single_task);
		spinnerPriority = (Spinner)findViewById(R.id.spinner2_edit_single_task);
		
		buttonsDate = (Button)findViewById(R.id.start_date_edit_single_task);
		buttonsTime = (Button)findViewById(R.id.start_time_edit_single_task);
		buttoneDate = (Button)findViewById(R.id.end_date_edit_single_task);
		buttoneTime = (Button)findViewById(R.id.end_time_edit_single_task);
...
//		planDes = plan.getPlanDescription();
		...
		save = (Button)findViewById(R.id.save_edit_single_task);
		cancel = (Button)findViewById(R.id.cancle_edit_single_task);
...
//				Log.v(tag, "MainActivity的OnCreate()函数被调用");
				...
				AlarmManage manage = new AlarmManage(EditSingleTaskActivity.this);
...
//					manage.cancleNotification(10000 + Integer.parseInt(taskNo)); 
				...
				Toast.makeText(EditSingleTaskActivity.this, "当前的NOTIFICATION_ID值为" + AlarmManage.NOTIFICATION_ID + "singleTsaskNo:" + taskNo, Toast.LENGTH_SHORT).show();
				
				/**通过Calendar对象cal将输入的日期、时间的具体数据赋值给
				 * year,month,day,hour,minute
				 * 这五个变量原来的值是当天的日期、时间*/
				EditSingleTaskActivity.this.finish();
			}
		});
	...
	public void initSpinnerDiff() {
		...
		spinnerDiff.setOnItemSelectedListener(new OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				//获取所选择的任务难度
				tdiff = arg2 + 1;
				//Toast.makeText(TaskEditActivity.this, "选择了" + (int)(arg2+1), Toast.LENGTH_LONG).show();
			}
...
//				Toast.makeText(CalendarAddActivity.this, "选择了" + (int)(arg2+1), Toast.LENGTH_LONG).show();
			...
			public void onNothingSelected(AdapterView<?> arg0) {
				//Toast.makeText(TaskEditActivity.this, "未选中", Toast.LENGTH_LONG).show();
			}
		}); 
	}
...
//		day = c.get(Calendar.DAY_OF_MONTH);
		...
		buttonsDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(EditSingleTaskActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//		buttoneTime.setText("" + ehour + ":" + eminute);
		...
		buttonsTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            	TimePickerDialog dialog = new TimePickerDialog(EditSingleTaskActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
